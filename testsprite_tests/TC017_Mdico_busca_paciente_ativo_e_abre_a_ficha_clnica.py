...
async def run_test():
    ...
    try:
        ...
        # -> Fill the CPF field with the medical CPF (Dra. Ana: 111.111.111-11) and the password field with '123', then submit the login form.
        ...
        # -> Type 'João' into the patient search field and open João Silva's clinical record by clicking his patient card.
