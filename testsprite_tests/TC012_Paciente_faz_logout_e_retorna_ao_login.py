...
async def run_test():
    ...
    try:
        ...
        # -> Fill the CPF field, fill the password field, and submit the login form by clicking 'Entrar'.
        ...
        # -> Open the profile page by clicking the 'Perfil' navigation link (index 203).
        # link "Perfil"
        elem = page.locator("xpath=/html/body/nav/a[4]").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Click the 'Sair da Conta' button (index 576) to log out, then verify the authentication/login screen is displayed.
