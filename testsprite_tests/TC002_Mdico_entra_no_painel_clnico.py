...
async def run_test():
    ...
    try:
        ...
        # -> Open the profile dropdown and select the 'Profissional de Saúde' (medical) profile.
        # "Paciente
Cuidador
Profissional de Saúde"
        ...
        # -> Fill CPF with 111.111.111-11, fill Senha with 123, then click the 'Entrar' button to attempt login as Dra. Ana.
