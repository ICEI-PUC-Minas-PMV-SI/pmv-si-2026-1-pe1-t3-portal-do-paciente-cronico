...
async def run_test():
    ...
    try:
        ...
        # -> Preencher CPF e senha do cuidador e submeter o formulário de login (clicar em Entrar). Depois verificar se a experiência do paciente associada ao cuidador é exibida.
